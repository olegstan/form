...
MaskedInput = exports["default"] = /*#__PURE__*/function (_BaseInput) {
  function MaskedInput(props) {var _this;_classCallCheck(this, MaskedInput);
  ...
  }_inherits(MaskedInput, _BaseInput);return _createClass(MaskedInput, [{ key: "render", value:
    ...
    function render() {var _this2 = this;
      ...
      if (
      typeof this.props.value === 'number' && this.props.value.toString().length > 0 ||
    ...
    } }]);}(_BaseInput2["default"]);_defineProperty(MaskedInput, "defaultProps", { onKeyPress: function onKeyPress() {}, onChange: function onChange() {}, disabled: false, value: '', placeholder: '', mask: '', icon: '', className: '', wrapperClassName: '', error: '' });
