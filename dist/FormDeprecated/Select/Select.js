...
var Select = /*#__PURE__*/function (_BaseInput) {
  /**
   *
   * @param props
   */
    ...
    value: function render() {
      ...
      return /*#__PURE__*/(0, _jsxRuntime.jsx)(_selectContainerStyle.Container, {
        ...
        children: /*#__PURE__*/(0, _jsxRuntime.jsxs)(_newstyles.InputWrapper, {
          ...
          }), resItems.length > 0 ? this.state.select && /*#__PURE__*/(0, _jsxRuntime.jsx)(_newstyles.Select, {
            id: this.props.id + '-select',
            className: this.props.className + ' select',
            select: true,
            children: resItems.map(function (item, key) {
              var shortName = '';
          ...
          }) : this.state.select && /*#__PURE__*/(0, _jsxRuntime.jsx)(_newstyles.Select, {
            id: this.props.id + '-select',
            className: this.props.className + ' select',
            select: true,
            children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_newstyles.Item, {
