...
var RelationGroupSelect = /*#__PURE__*/function (_BaseInput) {
  function RelationGroupSelect(props) {
    var _this;
    _classCallCheck(this, RelationGroupSelect);
  ...
  _inherits(RelationGroupSelect, _BaseInput);
  return _createClass(RelationGroupSelect, [{
        ...
        children: /*#__PURE__*/(0, _jsxRuntime.jsxs)(_styles.InputWrapper, {
          ...
          children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_styles.Selected, {
            ...
            children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_styles.Item, {
              onClick: function onClick() {
                handle(null);
                _this3.handleShowSelect(false);
              },
              children: /*#__PURE__*/(0, _jsxRuntime.jsx)("span", {
                children: this.props["default"]
              })
            }, 'default'), items.map(function (item, key) {
              return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_styles.Item, {
                children: [/*#__PURE__*/(0, _jsxRuntime.jsx)("span", {
                  children: item.user_account ? item.user_account.name + ' ' + item.currency.code : ''
                }), item.to_trades.length ? item.to_trades.map(function (trade) {
                  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_styles.SubItem, {
                    id: _this3.props.id + '-' + trade.id,
                    onClick: function onClick() {
                      handle(trade);
                      _this3.handleShowSelect(false);
                    },
                    children: trade.active.type_text + _this3.getName(trade) + ' - ' + _finhelper.Money.format(trade.count) + ' ' + trade.active.item.symbol + ' дата ' + trade.trade_at_date
                  }, trade.id);
                }) : /*#__PURE__*/(0, _jsxRuntime.jsx)(_styles.SubItem, {
                  children: "\u041D\u0435\u0442 \u0434\u043E\u0441\u0442\u0443\u043F\u043D\u044B\u0445 \u043F\u043E\u043A\u0443\u043F\u043E\u043A"
                })]
              }, key);
            })]
