...
GroupSelect = /*#__PURE__*/function (_BaseInput) {

  function GroupSelect(props)
  {var _this;_classCallCheck(this, GroupSelect);
  ...
  }_inherits(GroupSelect, _BaseInput);return _createClass(GroupSelect, [{ key: "handleClickOutside", value:
    ...
    {var _this2 = this;
      ...
      return /*#__PURE__*/(0, _jsxRuntime.jsx)(_selectContainerStyle.Container, { size: this.props.size, style: style, className: this.props.className, children: /*#__PURE__*/
        (0, _jsxRuntime.jsxs)(_styles.InputWrapper, { size: this.props.size, ref: this.wrapperRef, className: 'wrapper ' + (this.state.select ? 'select' : ''), children: [/*#__PURE__*/
          ...
          (0, _jsxRuntime.jsx)(_styles.Select, { id: this.props.id + '-select', className: this.props.className + ' select', select: this.state.select, children:
            items.map(function (item, key) {
              ...
              return item.items.length > 0 && /*#__PURE__*/(0, _jsxRuntime.jsxs)(_styles.Item, { className: "item", children: [/*#__PURE__*/
                (0, _jsxRuntime.jsx)("span", { children: shortName }),

                item.items.map(function (subItem, subKey) {
                  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_styles.SubItem, { className: "subitem", id: _this2.props.id + '-' + subItem.id, onClick: function onClick() {
                      handle(subItem);
