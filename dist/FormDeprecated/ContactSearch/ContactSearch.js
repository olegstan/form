...
ContactSearch = /*#__PURE__*/function (_Search) {
  ...
  {var _this;_classCallCheck(this, ContactSearch);
  ...
  }_inherits(ContactSearch, _Search);return _createClass(ContactSearch, [{ key: "handleAddContact", value:
    ...
    {var _this2 = this;
      ...
      .map(function (item, key) {
        return /*#__PURE__*/(0, _jsxRuntime.jsx)(_newstyles.Item, { className: _this2.props.className + ' item ' + (_this2.state.hovered === key ? 'hovered' : ''), id: _this2.props.id + '-' + item.id, onClick: function onClick(e) {
            e.stopPropagation();
      ...
      return /*#__PURE__*/(0, _jsxRuntime.jsx)(_newstyles.Container, { dataid: "search", style: this.getContainerStyle(), className: this.props.className, children: /*#__PURE__*/
        (0, _jsxRuntime.jsx)(_newstyles.InputWrapper, {
          ...
          (0, _jsxRuntime.jsxs)(_newstyles.InputContainer, { style: this.getInputContainerStyle(), ref: this.wrapperRef, children: [/*#__PURE__*/
            ...
            (0, _jsxRuntime.jsxs)(_newstyles.Select, { id: this.props.id + '-select', className: this.props.className + ' select', select: this.state.select || this.state.focused, style: selectStyle, onClick: function onClick(e) {
                e.stopPropagation();
              }, children: [
              ...
              this.props.contactAddAvailable && /*#__PURE__*/(0, _jsxRuntime.jsx)(_newstyles.Add, { className: this.props.className + ' add', onClick: function onClick() {_this2.handleAddContact();}, children: /*#__PURE__*/
    ...
    } }]);}(_Search2["default"]);var _default = exports["default"] =
