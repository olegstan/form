...
function getLink(Base) {
  var GetLink = /*#__PURE__*/function (_Base) {
    function GetLink() {
      _classCallCheck(this, GetLink);
      return _callSuper(this, GetLink, arguments);
    }
    _inherits(GetLink, _Base);
    return _createClass(GetLink, [{
      key: "clearFormError",
      ...
      key: "getDisabled",
      value: function getDisabled(bool) {
        if (bool === true) {
          return true;
        }
        if (bool === false) {
      ...
      key: "setValueInput",
      value: function setValueInput(prv, field, value) {
        var parts = field.split('.');
        if (parts.length === 1) {
          try {
