...
function formSelect(Base) {
  var FormSelect = /*#__PURE__*/function (_Base) {
    function FormSelect() {
      _classCallCheck(this, FormSelect);
      return _callSuper(this, FormSelect, arguments);
    }
    _inherits(FormSelect, _Base);
    return _createClass(FormSelect, [{
      key: "getValueSelect",
      value: function getValueSelect(prv, field) {
      ...
      key: "setValueSelect",
      value: function setValueSelect(prv, field, item) {
        var parts = field.split('.');
        if (parts.length === 1) {
          prv.form[field] = item;
      ...
      key: "renderSlimSelect",
      value: function renderSlimSelect() {
        var _this2 = this;
      ...
      key: "renderSelectStyle1",
      value: function renderSelectStyle1() {
