...
function receivePropsUserId(Base) {
  var ReceivePropsUserId = /*#__PURE__*/function (_Base) {
    function ReceivePropsUserId() {
      _classCallCheck(this, ReceivePropsUserId);
      return _callSuper(this, ReceivePropsUserId, arguments);
    }
    _inherits(ReceivePropsUserId, _Base);
    return _createClass(ReceivePropsUserId, [{
