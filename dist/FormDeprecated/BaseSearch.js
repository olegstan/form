...
var BaseSearch = exports["default"] = /*#__PURE__*/function (_BaseInput) {
  function BaseSearch() {
    _classCallCheck(this, BaseSearch);
    return _callSuper(this, BaseSearch, arguments);
  }
  _inherits(BaseSearch, _BaseInput);
  return _createClass(BaseSearch, [{
    key: "getInputStyle",
    ...
    key: "getInputContainerStyle",
    value: function getInputContainerStyle() {
    ...
    key: "setSearch",
    value: function setSearch(nextProps) {
    ...
    value: function getWrapperClasses(items) {
