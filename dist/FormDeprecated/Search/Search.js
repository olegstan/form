...
Search = /*#__PURE__*/function (_BaseSearch) {
  ...
  {var _this;_classCallCheck(this, Search);
  ...
  }_inherits(Search, _BaseSearch);return _createClass(Search, [{ key: "handleClickOutside", value:
    ...
    function render()
    {var _this4 = this;
      var _this$props = this.props,items = _this$props.items,handle = _this$props.handle,selected = _this$props.selected,name = _this$props.name,selectStyle = _this$props.selectStyle,clearImageStyle = _this$props.clearImageStyle;
      ...
      return /*#__PURE__*/(0, _jsxRuntime.jsx)(_newstyles.Container, { dataid: "search", style: this.getContainerStyle(), className: this.props.className, children: /*#__PURE__*/
        (0, _jsxRuntime.jsx)(_newstyles.InputWrapper, {
          ...
          (0, _jsxRuntime.jsxs)(_newstyles.InputContainer, { style: this.getInputContainerStyle(), ref: this.wrapperRef, children: [/*#__PURE__*/
            ...
            (0, _jsxRuntime.jsx)(_newstyles.Select, { id: this.props.id + '-select', className: this.props.className + ' select', select: this.state.select || this.state.focused, style: selectStyle, onClick: function onClick(e) {
                e.stopPropagation();
              }, children:
    ...
    } }]);}(_BaseSearch2["default"]);_defineProperty(Search, "defaultProps", { showClearIcon: true, selectStyle: {} });var _default = exports["default"] =
