...
function _setPrototypeOf(t, e) { return _setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function (t, e) { return t.__proto__ = e, t; }, _setPrototypeOf(t, e); } // import InputWithCurrency from "./InputWithCurrency/InputWithCurrency";
// import SelectWithDays from "./SelectWithDays/SelectWithDays";
var Form = exports["default"] = /*#__PURE__*/function (_Multi$extend) {
  function Form() {
    _classCallCheck(this, Form);
    return _callSuper(this, Form, arguments);
  }
  _inherits(Form, _Multi$extend);
  return _createClass(Form, [{
    key: "renderGroupMultipleSelect",
    value:
    ...
    function renderGroupMultipleSelect(field, items, text, defaultText) {
      var _this = this;
    ...
    key: "renderMultipleSelect",
    value: function renderMultipleSelect() {
      var _this2 = this;
    ...
    key: "renderMultipleSelectStyle1",
    value: function renderMultipleSelectStyle1() {
    ...
    key: "renderGroupSelect",
    value: function renderGroupSelect() {
      var _this3 = this;
    ...
    key: "renderGroupSelectStyle1",
    value: function renderGroupSelectStyle1() {
    ...
    key: "renderRelationGroupSelect",
    value: function renderRelationGroupSelect(field, items, text, defaultText) {
      var _this4 = this;
      var disabled = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
      var callback = arguments.length > 5 ? arguments[5] : undefined;
    ...
    key: "renderSearchMultiple",
    value: function renderSearchMultiple() {
      var _ref5 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        ...
        _ref5$allowAdd = _ref5.allowAdd,
        allowAdd = _ref5$allowAdd === void 0 ? false : _ref5$allowAdd,
        _ref5$onCreate = _ref5.onCreate,
        _onCreate = _ref5$onCreate === void 0 ? function (value) {} : _ref5$onCreate,
        _onAddElement = _ref5.onAddElement,
        _onRemoveElement = _ref5.onRemoveElement,
        _ref5$onOutsideClick = _ref5.onOutsideClick,
        _onOutsideClick = _ref5$onOutsideClick === void 0 ? function () {} : _ref5$onOutsideClick,
        id = _ref5.id,
        _ref5$style = _ref5.style,
        style = _ref5$style === void 0 ? {} : _ref5$style,
        _ref5$containerStyle = _ref5.containerStyle,
        containerStyle = _ref5$containerStyle === void 0 ? {} : _ref5$containerStyle,
        _ref5$controlStyle = _ref5.controlStyle,
        controlStyle = _ref5$controlStyle === void 0 ? {} : _ref5$controlStyle,
        _ref5$valueContainerS = _ref5.valueContainerStyle,
        valueContainerStyle = _ref5$valueContainerS === void 0 ? {} : _ref5$valueContainerS,
        _ref5$nativeContainer = _ref5.nativeContainerStyle,
        nativeContainerStyle = _ref5$nativeContainer === void 0 ? {} : _ref5$nativeContainer;
    ...
    key: "renderSearchWithButton",
    value: function renderSearchWithButton(field, items, text, defaultText) {
      var _this5 = this;
      var disabled = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
      var onSearch = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : function () {};
      var callback = arguments.length > 6 ? arguments[6] : undefined;
      var buttonClick = arguments.length > 7 && arguments[7] !== undefined ? arguments[7] : function () {};
      var id = arguments.length > 8 ? arguments[8] : undefined;
      var style = arguments.length > 9 ? arguments[9] : undefined;
    ...
    key: "renderSearchWithButtonStyle1",
    value: function renderSearchWithButtonStyle1(field, items, text, defaultText) {
      var _this6 = this;
      var disabled = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
      var onSearch = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : function () {};
      var callback = arguments.length > 6 ? arguments[6] : undefined;
    ...
    value: function renderLogs() {
      ...
      return this.state.logs && this.state.logs.map(function (log, key) {
        return /*#__PURE__*/(0, _jsxRuntime.jsx)(_Input["default"], {
          ...
          placeholder: '',
          errors: _this7.state.formErrors
        }, log.id);
      });
    }
  }, {
    key: "renderEmpty",
    value: function renderEmpty(size) {
