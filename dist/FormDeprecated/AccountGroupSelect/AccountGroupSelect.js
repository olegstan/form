...
var AccountGroupSelect = exports.AccountGroupSelect = /*#__PURE__*/function (_BaseInput) {
  function AccountGroupSelect(props) {
    var _this;
    _classCallCheck(this, AccountGroupSelect);
  ...
  _inherits(AccountGroupSelect, _BaseInput);
  return _createClass(AccountGroupSelect, [{
    ...
    key: "handleAddAccount",
    value: function handleAddAccount() {
      var _this3 = this;
      this.setState({
    ...
    key: "renderCreateComponent",
    value: function renderCreateComponent() {
      var _this4 = this;
      var _this$state = this.state,
        ComponentCreate = _this$state.moduleAccountCreate,
        ComponentEdit = _this$state.moduleAccountEdit;
    ...
    value: function render() {
      ...
      var _this$props2 = this.props,
        ...
        showDefault = _this$props2.showDefault;
      var focus = this.state.hasError ? {
        'border': '1px solid #EF5E70'
      } : {};

      //TODO сделать добавление субсчета
      return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_selectContainerStyle.Container, {
        ...
        children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)(_styles.InputWrapper, {
          ...
          children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_styles.Selected, {
          ...
          }), /*#__PURE__*/(0, _jsxRuntime.jsxs)(_styles.Select, {
            style: {
            ...
            children: [showDefault && /*#__PURE__*/(0, _jsxRuntime.jsx)(_styles.Item, {
              className: "item",
              onClick: function onClick() {
                handle(null);
            ...
            }), this.props.accountAddAvailable && /*#__PURE__*/(0, _jsxRuntime.jsx)(_styles.Add, {
              className: this.props.className + ' add',
              onClick: function onClick() {
                _this5.handleAddAccount();
              },
              children: /*#__PURE__*/(0, _jsxRuntime.jsx)("span", {
...
var _default = exports["default"] = AccountGroupSelect;