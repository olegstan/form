...
GroupMultipleSelect = /*#__PURE__*/function (_BaseInput) {

  function GroupMultipleSelect(props)
  {var _this;_classCallCheck(this, GroupMultipleSelect);
    _this = _callSuper(this, GroupMultipleSelect, [props]);
  ...
  }_inherits(GroupMultipleSelect, _BaseInput);return _createClass(GroupMultipleSelect, [{ key: "handleClickOutside", value:
    ...
    {var _this2 = this;
      ...
      if (selected.length)
      {
        ...
        items.map(function (item)
        {
          ...
          {
            if (_this2.props.selected.indexOf(subItem.id) !== -1)
            {
    ...
    function render()
    {var _this3 = this;
      var _this$props2 = this.props,items = _this$props2.items,handle = _this$props2.handle,showAll = _this$props2.showAll;

      var error = this.getError();
      var focus = this.state.hasError ? { 'border': '1px solid #FF0000' } : {};

      return /*#__PURE__*/(0, _jsxRuntime.jsx)(_selectContainerStyle.Container, { className: this.props.className + ' multi-select', style: this.props.style, children: /*#__PURE__*/
        (0, _jsxRuntime.jsxs)(_styles.InputWrapper, { ref: this.wrapperRef, style: focus, children: [/*#__PURE__*/
          ...
          (0, _jsxRuntime.jsxs)(_styles.Select, { id: this.props.id + '-multi-select', className: this.props.className + ' select', select: this.state.select, children: [
            ...
            items.map(function (item, key) {return (/*#__PURE__*/
                (0, _jsxRuntime.jsxs)(_styles.Item, { id: _this3.props.id + '-' + item.id, className: _this3.props.className, children: [/*#__PURE__*/
                  (0, _jsxRuntime.jsx)("span", { children: item.name }),
                  item.items.map(function (subItem, subKey) {return (/*#__PURE__*/
                      (0, _jsxRuntime.jsx)(_Checkbox["default"], {

                        id: _this3.props.id + '-subitem-' + subItem.id,
                        text: subItem.name,
                        checked: _this3.props.selected.indexOf(subItem.id) !== -1,
                        toggleCallback: function toggleCallback(e) {handle(subItem);} }, subKey
                      ));}
                  )] }, item.id
                ));}
            )] }
...
GroupMultipleSelect;
//# sourceMappingURL=GroupMultipleSelect.js.map