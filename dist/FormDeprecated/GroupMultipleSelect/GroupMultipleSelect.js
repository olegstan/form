...
var GroupMultipleSelect = /*#__PURE__*/function (_BaseInput) {
  function GroupMultipleSelect(props) {
    var _this;
    _classCallCheck(this, GroupMultipleSelect);
  ...
  _inherits(GroupMultipleSelect, _BaseInput);
  return _createClass(GroupMultipleSelect, [{
    ...
    value: function renderSelectAll() {
      ...
      if (this.props.selected.length) {
        return /*#__PURE__*/(0, _jsxRuntime.jsx)(_Checkbox["default"], {
          ...
          text: 'Снять все',
          checked: true,
          toggleCallback: function toggleCallback(e) {
            handleAll(false);
          }
        });
      } else {
      ...
      return /*#__PURE__*/(0, _jsxRuntime.jsx)(_selectContainerStyle.Container, {
        ...
        children: /*#__PURE__*/(0, _jsxRuntime.jsxs)(_styles.InputWrapper, {
          ...
          children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_styles.Selected, {
            ...
            children: [showAll ? this.renderSelectAll() : '', items.map(function (item, key) {
              return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_styles.Item, {
                id: _this3.props.id + '-' + item.id,
