...
var Date = exports["default"] = /*#__PURE__*/function (_BaseInput) {
  function Date(props) {
    var _this;
    ...
    _this.wrapperRef = /*#__PURE__*/(0, _react.createRef)(); // Use ref API instead of findDOMNode
    _this.inputRef = /*#__PURE__*/(0, _react.createRef)(); // Create ref for input
    _this.handleClickOutside = _this.handleClickOutside.bind(_this);
    _this.flatpickrInstance = null; // Track the flatpickr instance
    return _this;
  }
  _inherits(Date, _BaseInput);
  return _createClass(Date, [{
    ...
    value: function componentDidMount() {
      ...
      Promise.all([Promise.resolve().then(function () {
        ...
        var DateStyledInput = (0, _styledComponents["default"])(Flatpickr["default"])(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n                ", "\n            "])), _newstyles.sharedInputStyle);
        _this3.setState({
    ...
    value: function render() {
      ...
      var _this$state = this.state,
        ...
        componentsLoaded = _this$state.componentsLoaded;
      return componentsLoaded ? /*#__PURE__*/(0, _jsxRuntime.jsx)(_containerStyle.Container, {
        ...
        children: /*#__PURE__*/(0, _jsxRuntime.jsxs)(_newstyles.InputContainer, {
          ...
          ,
          children: [this.props.disabled ? this.renderInput() : /*#__PURE__*/(0, _jsxRuntime.jsx)(Input, {
            id: this.props.id,
          ...
          }), this.renderPlaceholder(), this.props.icon !== false && /*#__PURE__*/(0, _jsxRuntime.jsx)("img", {
            className: "calendar",
...
_defineProperty(Date, "defaultProps", {
  ...
  onChangeDateInner: function onChangeDateInner() {},
  disabled: false,
  value: '',
  placeholder: '',
  mask: '',
