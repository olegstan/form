...
Input = exports["default"] = /*#__PURE__*/function (_BaseInput) {

  function Input(props)
  {var _this;_classCallCheck(this, Input);
  ...
  /**
   *
   */_inherits(Input, _BaseInput);return _createClass(Input, [{ key: "render", value:
    ...
    } }]);}(_BaseInput2["default"]);_defineProperty(Input, "defaultProps", { onKeyPress: function onKeyPress() {}, onChange: function onChange() {}, disabled: false, value: '', placeholder: '', icon: '', className: '', wrapperClassName: '', error: '', type: 'text', style: {} });
