...
var _InputContainer = require("../InputContainer");var _jsxRuntime = require("react/jsx-runtime");function _interopRequireDefault(e) {return e && e.__esModule ? e : { "default": e };} /**
...
var CloseIcon = /*#__PURE__*/(0, _react.memo)(function CloseIcon(_ref)
  ...
  {var typeName = _ref.typeName,icon = _ref.icon,search = _ref.search,onSearch = _ref.onSearch,loading = _ref.loading,disabled = _ref.disabled,name = _ref.name,value = _ref.value,onChange = _ref.onChange;
    ...
    return (
      notEmpty && !loading && !disabled && /*#__PURE__*/(0, _jsxRuntime.jsx)("img", {
        className: "close",
