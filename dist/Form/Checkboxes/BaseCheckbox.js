...
var BaseCheckbox = function BaseCheckbox(_ref)
...
{var _ref$value = _ref.value,value = _ref$value === void 0 ? 1 : _ref$value,_ref$name = _ref.name,name = _ref$name === void 0 ? '' : _ref$name,_ref$toggleCallback = _ref.toggleCallback,toggleCallback = _ref$toggleCallback === void 0 ? function () {} : _ref$toggleCallback,textStyle = _ref.textStyle,id = _ref.id,checked = _ref.checked,checkboxStyle = _ref.checkboxStyle,style = _ref.style,text = _ref.text,StyledComponent = _ref.StyledComponent;
  ...
  return (/*#__PURE__*/
    (0, _jsxRuntime.jsxs)(StyledComponent, {
      style: style,
      ...
      (0, _jsxRuntime.jsx)("input", {
        ...
        onChange: function onChange(event) {return toggleCallback ? toggleCallback(event.target.checked, event) : function () {};},
        name: name,
        type: "checkbox",
        value: value,
        checked: checked }
