...
var GroupSelectWithSearch = function GroupSelectWithSearch(_ref)
...
{var _ref$focused = _ref.focused,focused = _ref$focused === void 0 ? false : _ref$focused,_ref$setFocused = _ref.setFocused,setFocused = _ref$setFocused === void 0 ? function () {} : _ref$setFocused,_ref$onBlur = _ref.onBlur,onBlur = _ref$onBlur === void 0 ? function () {} : _ref$onBlur,_ref$onKeyDown = _ref.onKeyDown,onKeyDown = _ref$onKeyDown === void 0 ? function () {} : _ref$onKeyDown,_ref$onChange = _ref.onChange,onChange = _ref$onChange === void 0 ? function () {} : _ref$onChange,_ref$onClick = _ref.onClick,onClick = _ref$onClick === void 0 ? function () {} : _ref$onClick,_ref$disabled = _ref.disabled,disabled = _ref$disabled === void 0 ? false : _ref$disabled,_ref$className = _ref.className,className = _ref$className === void 0 ? '' : _ref$className,_ref$style = _ref.style,style = _ref$style === void 0 ? {} : _ref$style,id = _ref.id,name = _ref.name,value = _ref.value,error = _ref.error,_ref$options = _ref.options,options = _ref$options === void 0 ? [] : _ref$options,_ref$search = _ref.search,search = _ref$search === void 0 ? '' : _ref$search,_ref$onSearch = _ref.onSearch,onSearch = _ref$onSearch === void 0 ? function () {} : _ref$onSearch,_ref$clearOnClickOuts = _ref.clearOnClickOutside,clearOnClickOutside = _ref$clearOnClickOuts === void 0 ? true : _ref$clearOnClickOuts,_ref$addButton = _ref.addButton,addButton = _ref$addButton === void 0 ? false : _ref$addButton,_ref$getText = _ref.getText,getText = _ref$getText === void 0 ? function (item, subItem) {return (subItem === null || subItem === void 0 ? void 0 : subItem.name) || '';} : _ref$getText;
  ...
  var selectedOption = (0, _react.useMemo)(function () {
    ...
    if (!foundOption) {
      ...
      var _iterator2 = _createForOfIteratorHelper(options),_step2;try {for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {var option = _step2.value;
          //@ts-ignore
...
GroupSelectWithSearch.displayName = 'GroupSelectWithSearch';var _default = exports["default"] =

GroupSelectWithSearch;
//# sourceMappingURL=GroupSelectWithSearch.js.map