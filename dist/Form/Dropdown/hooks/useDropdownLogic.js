...
var useDropdownLogic = exports.useDropdownLogic = function useDropdownLogic(props, wrapperRef, onSearch, handle) {
  ...
  var onKeyDown = (0, _react.useCallback)(function (event) {
    var _props$items = props.items,items = _props$items === void 0 ? [] : _props$items;

    var searchLower = (searchValue || '').toLowerCase();
    var filteredItems = items.filter(function (item) {
      if (!searchLower) return true;
      var parts = searchLower.split(' ');
      var partsFound = 0;var _iterator = _createForOfIteratorHelper(
          parts),_step;try {for (_iterator.s(); !(_step = _iterator.n()).done;) {var _item$name;var part = _step.value;
...
//# sourceMappingURL=useDropdownLogic.js.map