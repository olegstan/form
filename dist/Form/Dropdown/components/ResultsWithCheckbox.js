...
// @ts-ignore
var ResultsWithCheckbox = function ResultsWithCheckbox(_ref) {var
    id = _ref.id,
    values = _ref.values,
    ...
    (0, _jsxRuntime.jsx)(_styles.OptionsWrapper, { active: active !== null && active !== void 0 ? active : false, id: id ? "".concat(id, "-select") : undefined, children:
      ...
      (0, _jsxRuntime.jsxs)(_jsxRuntime.Fragment, { children: [
        ...
        handleClickAll && /*#__PURE__*/(0, _jsxRuntime.jsx)(_ItemWithCheckbox["default"], {
          item: (values === null || values === void 0 ? void 0 : values.length) === (options === null || options === void 0 ? void 0 : options.length) ? { id: 'all', name: 'Снять выбор' } : { id: 'all', name: 'Выбрать все' },
...
ResultsWithCheckbox;
//# sourceMappingURL=ResultsWithCheckbox.js.map