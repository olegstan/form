"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.getDecimal = exports.formatForInput = void 0;
var getDecimal = exports.getDecimal = function getDecimal(decimalCount, amount) {
  ...
  return { decimalCount: decimalCount, negativeSign: negativeSign };
};

var formatForInput = exports.formatForInput = function formatForInput(amount)
{var decimalCount = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 2;var decimalSign = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : ".";var thousands = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : " ";
  try
  {
    if (amount === '')
    {
