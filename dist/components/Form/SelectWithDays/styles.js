...
const DaysContainer = exports.DaysContainer = _styledComponents.default.div(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n    display: flex;\n    \n    \n    \n"])));
const DaysTitle = exports.DaysTitle = _styledComponents.default.div(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n    text-align: left;\n    width: 100%;\n    margin-left: 10px;\n    font-size: 16px;\n"])));
const Day = exports.Day = _styledComponents.default.div(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n    height: 30px;\n    width: 30px;\n    border-radius: 20px;\n    line-height: 30px;\n    margin: 10px;\n    cursor: pointer;\n    \n    &.active{\n      background-color: #51A0FA;\n      color: #fff;\n    }\n"])));